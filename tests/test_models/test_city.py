...
class TestCity_instantiation(unittest.TestCase):
    """These are Unittests for testing instantiation of the City class."""
...
class TestCity_to_dict(unittest.TestCase):
    """  These are Unittests for testing to_dict method of the City class."""
...
class TestCity_save(unittest.TestCase):
    """These are Unittests for testing save method of the City class."""
